import { enumControlColumnElement, IFe3SelElement } from "src/Interfaces/IState"
...
//Concise alternative
export const remodelPending = (boolState: boolean) => ({ type: NEW_MODEL_PENDING, boolState: boolState, })
