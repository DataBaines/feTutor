...
const Fe3Mesh = (props) => {
  const { componentProps, addPerimNodes, nodeSelect, elementSelect, addLogText, nodeMove } = props
  const { fe3Mesh, selNode, selElement, threeControl, moveNodeMode, newModelPending, mesh3D} = componentProps
  ...
  return (
      <div>
        {componentProps.modelFlags && componentProps.modelFlags.newModelPending && <div className="loader" />}
