...
class ZThreeModel extends React.Component {
    constructor(){
        super()
    ...
    componentDidMount() {
        ...
        function createNodes() {
            ...
            for (var i = 0; i < 10; i++) {
                ...
                var node = new THREE.SphereGeometry(.02, Math.random() * .03, Math.random() * .03);
            ...
            //creating the mesh and add primitive and material
                var particle = new THREE.Mesh(node, material);
            ...
            nodes.position.y = 0.5;//500;
            nodes.position.x = 1;//-2000;
            nodes.position.z = 0.5;//-100;
            nodes.rotation.y = Math.PI * 600;
            //add spheres to the scene
            WritePos("sphere", nodes.position.x, nodes.position.y, nodes.position.z)
            scene.add(nodes);
        }
