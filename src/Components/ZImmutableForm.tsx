...
import { load as loadAccount } from '../Reducers/ZImmut'
...
ImmutableForm = connect(
  state => ({ initialValues: data }), // pull initial values from account reducer //replaces mapStateToProps
  { load: loadAccount } // bind account loading action creator //replaces mapdispatchToProps
)(ImmutableForm)
